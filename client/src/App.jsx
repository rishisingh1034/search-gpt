...
function App() {
  ...
  return (
    <div className='bg-[#1A232E] h-screen py-6 relative sm:px-16 px-12~ text-white overflow-hidden flex flex-col justify-between align-middle'>
      ...
      {/* gradiant */}
      <div className='gradient-01 z-0 absoulte'></div>
      <div className='gradient-02 z-0 absoulte '></div>

      {/* header */}
      <div className='uppercase font-bold text-2xl text-center mb-3'>SearchGPT</div>
      ...
      {/* input */}
      <div className='w-full max-w-4xl min-w-[20px] self-center'>
        <ChatInput/>
      </div>
    </div>
  )
